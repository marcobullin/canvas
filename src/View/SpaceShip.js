define([
    ...
    View.SpaceShip = Backbone.View.extend({
        ...
        attack: function (enemy, weapon) {
            ...
            var direction = Math.atan2(enemy.get('positionY') + enemy.get('height')/2 - weapon.positionY, enemy.get('positionX') + enemy.get('width')/2 - weapon.positionX) - Math.PI/2;
            ...
            var randX = Math.floor(Math.random() * enemy.get('width') + enemy.get('positionX')),
